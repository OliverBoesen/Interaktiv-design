document.addEventListener("DOMContentLoaded", function() {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    const section1900 = document.getElementById("1900");
    const container1900 = document.querySelector(".container-1900");
    const img1900 = document.querySelector(".img-1900");
    const tekst1900 = document.querySelector(".tekst-1900");
    const body = document.querySelector("body");
