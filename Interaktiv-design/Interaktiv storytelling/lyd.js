...
var lydAfspiller = document.getElementById("lydAfspiller1900");
   ...
   var nittenti = document.getElementById("lydAfspiller1910");
   var nittentiKnap = document.getElementById("lydKnappen1910");
   var nittentiLyd = document.getElementById("nittentiLyd");

   nittentiKnap.addEventListener("click", function() {
       if (nittenti.paused) {
        nittenti.play();
        nittentiLyd.src = "img/lydknap_fra.png"; // Ændrer billedkilden til pause-billede
       } else {
        nittenti.pause();
        nittenti.currentTime = 0;
        nittentiLyd.src = "img/lydknap.png"; // Ændrer billedkilden tilbage til start-billede
       }
   });
