...
netentyvetrueBtn.addEventListener('click', () => {
  netentyvestatement.innerText = 'Det er falsk! Pigerne klippede håret kort og det "drengede" look blev voldsomt populært!';
  netentyvepopupContent.style.backgroundColor = '#ef5d53'; // Ændrer baggrundsfarve til rød
  netentyvefalseBtn.style.backgroundColor = ''; // Nulstiller "Falsk" knappens farve
});

netentyvefalseBtn.addEventListener('click', () => {
  netentyvestatement.innerText = 'Du har ret! Pigerne klippede håret kort og det "drengede" look blev voldsomt populært! ';
  netentyvepopupContent.style.backgroundColor = '#8ce68c'; // Ændrer baggrundsfarve til grøn
